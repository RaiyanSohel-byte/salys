...
function VerifyContent() {
  ...
  const getIcon = () => {
    switch (status) {
      ...
      case "success":
        return (
          <MdVerified className="text-6xl text-green-500 animate-bounce" />
        );
      case "error":
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br ${getBackgroundGradient()} flex items-center justify-center `}
    >
      <div
        className={` bg-white rounded-2xl shadow-2xl border-2 ${getCardBorder()} p-4 sm:p-6 md:p-8 text-center`}
      >
        {/* Icon */}
        <div className="mb-4 sm:mb-6 flex justify-center">{getIcon()}</div>
