...
const page = () => {
  ...
  console.log(subscription, "subscription in music page");
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] w-full">
          <div className="flex flex-col items-center bg-gradient-to-br from-blue-50 to-blue-200 rounded-2xl shadow-2xl p-10 border border-blue-200 max-w-md w-full animate-bounce-in">
            <svg
              className="mb-4 text-blue-500 animate-pulse"
              width="56"
              height="56"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <h2 className="text-3xl font-extrabold mb-2 text-blue-900 tracking-wide drop-shadow">
              Subscription Required
            </h2>
            <p className="mb-1 text-blue-800 text-base text-center">
              Your subscription has expired or is inactive.
            </p>
            <p className="mb-2 text-blue-700 text-sm text-center">
              Please renew your membership to access the music features.
            </p>
          </div>
        </div>
      );
